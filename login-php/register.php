            ...
            <span class="login100-form-title p-b-10">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					<div class="wrap-input100 validate-input <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>" data-validate = "Enter username">
						<input class="input100" type="text" name="username" placeholder="Usuario" value="<?php echo $username; ?>">
					...
					<div class="wrap-input100 validate-input <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>" data-validate="Enter password">
						<input class="input100" type="password" name="confirm_password" placeholder="Confirmar contraseña" value="<?php echo $confirm_password; ?>">
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<button class="login100-form-btn" type="reset">Borrar</button>
					</div><BR>
					 <center> <p>¿Ya tienes una cuenta? <a href="login.php"><u>Ingresa aquí</a></u>.</p></center>
